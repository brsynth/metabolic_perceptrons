...
# to obtain parameters confidence eintervals
...
saving_graph(filename = paste("biosensor_mean_linear_simulation.jpeg", sep = '_'), path =folder_for_images)
...
write.csv(biosensor_mean_fit, paste(folder_for_images, "biosensor_mean_linear_simulation_fit.csv", sep = '/'), row.names = FALSE)
