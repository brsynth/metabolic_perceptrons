...
# Aim: Predict the full OR classifier for best prediction and working experimental implementation
...
results_dataframe = cbind(results_dataframe, "names" = names_of_combinations , "expected" = all_classifiers[,c("or_gate")], "value" = calculated_gate)

testing_threshold = c(1, 1.2, 1.5,2,2.2, 2.5,2.7, 3, 3.2, 3.5, 3.7, 4, 4.2, 4.5)
...
write.table(results_dataframe, paste("or_", paste(weights, collapse = "_"), ".csv", sep = ''), sep = ";")
plot_logic_gates(results_dataframe, testing_threshold = testing_threshold, 
                 name_for_saving = paste("or_", paste(weights, collapse = "_"), sep = ''),
                 title = "Predicting full or gate")
